...
class TranscriptTestBase:
    ...
    def __init__(self, **kwargs):
        # transcriber is a function that takes a path to an audio file and returns a transcript, should be provided by the model
        self.transcriber: Optional[Callable] = None

        # normalizer is a function that takes a transcript and returns a normalized transcript, see lib/normalizers.py for examples
